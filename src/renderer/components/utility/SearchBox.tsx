...
function SerchBox(props: Props) {
  ...
  return (
    <SerchBoxWrapper className="flex gap-2 items-center border-1 border-gray-500 rounded-xl p-2 cursor-pointer text-gray-500 hover:border-gray-600 hover:text-gray-600">
      <label className="">
